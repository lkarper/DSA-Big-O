...
// Polynomial time O(n^k); exponent remains constant with input size
...
// Exponential time O(2^n); exponent varies with input
function countTriangle(layers) {
    // this is a stupid function that counts one by one, instead of raising things to a power.  Does the same as exponentialGrowth func below
    let ticks = 1;
